...
public abstract class AbstractReportGenerator {
    ...
    public void generateReport(final OutputType outputType, File outputFile)
        ...
        if(outputFile == null) {
            throw new IllegalArgumentException("File hasil tidak dijelaskan.");
        }
    ...
    public void generateReport(final OutputType outputType, OutputStream outputStream)
        ...
        if(outputStream == null) {
            throw new IllegalArgumentException("Output Stream tidak ditentukan");
        }
        ...
        try {
            switch(outputType) {
                ...
                case HTML: {
                    ...
                    printer.setContentWriter(targetRoot, new DefaultNameGenerator(targetRoot, "index",
                            "html"));
